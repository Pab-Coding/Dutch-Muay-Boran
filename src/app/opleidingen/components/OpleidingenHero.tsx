          ...
          >
            <MotionDiv
              ...
              className="inline-block bg-gradient-to-r from-red-500/20 to-blue-500/20
                         backdrop-blur-sm rounded-lg px-3 py-1.5 sm:px-4 sm:py-2 mb-4 sm:mb-6"
            >
            ...
            <div className="mb-4 sm:mb-6">
              <MotionH1
                ...
                className="text-4xl sm:text-5xl md:text-7xl font-bold text-transparent bg-clip-text
                           ...
                           leading-[1.2] pb-2 sm:pb-4 max-w-full"
              >
                Opleidingen
              </MotionH1>
            </div>
            ...
            <MotionP
              variants={childVariants}
              className="mt-4 md:mt-8 text-lg sm:text-xl md:text-2xl text-gray-200 font-medium
