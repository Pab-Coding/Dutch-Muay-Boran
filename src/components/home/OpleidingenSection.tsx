    ...
    <section ref={sectionRef} className="w-full px-4">
      ...
      >
        <motion.h2
          ...
          className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-800 via-blue-600 to-gray-800 mb-8 text-center tracking-tight"
        >
          Onze Opleidingen
        </motion.h2>
                  ...
                  <div className="flex flex-col gap-4">
                    <Link href="/opleidingen/cursusdata">
                      <MotionDiv
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="flex items-center gap-2 w-fit px-4 py-2 bg-gradient-to-r from-red-500/30 to-blue-500/30 hover:from-red-500/40 hover:to-blue-500/40 backdrop-blur-sm rounded-lg cursor-pointer transition-all duration-300"
                      >
                    ...
                    <div className="flex items-center gap-4">
                      <Link href="/opleidingen/inschrijven">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          className="px-4 py-2 bg-white text-gray-900 rounded-lg font-semibold flex items-center space-x-2 hover:bg-gray-100 transition-colors shadow-md hover:shadow-xl min-w-[120px]"
                        >
                      ...
                      <Link href={course.path}>
                        <motion.button
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                          className="px-4 py-2 border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-all backdrop-blur-sm hover:shadow-xl min-w-[120px]"
                        >
                          Meer Info
                        </motion.button>
                      </Link>
